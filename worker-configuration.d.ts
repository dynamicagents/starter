/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bfedf9211302aff368f0d28bb8b2a405)
// Runtime types generated with workerd@1.20260921.1 2026-07-06 nodejs_compat
interface __BaseEnv_Env {
	...
	GITHUB_NAME: string;
	GITHUB_EMAIL: string;
	CLAUDE_CODE_OAUTH_TOKEN_1: string;
	CLAUDE_CODE_OAUTH_TOKEN_2: string;
	CLAUDE_CODE_OAUTH_TOKEN_3: string;
	ReactiveAgent: DurableObjectNamespace<import("./src/index").ReactiveAgent>;
	ProactiveAgent: DurableObjectNamespace<import("./src/index").ProactiveAgent>;
	ArcPlayerAgent: DurableObjectNamespace<import("./src/index").ArcPlayerAgent>;
	CfCoderAgent: DurableObjectNamespace<import("./src/index").CfCoderAgent>;
	ClaudeCoderAgent: DurableObjectNamespace<import("./src/index").ClaudeCoderAgent>;
	CF_CODER_WORKSPACE: DurableObjectNamespace<import("./src/index").CfCoderWorkspaceDO>;
	CLAUDE_CODER_WORKSPACE: DurableObjectNamespace<import("./src/index").ClaudeCoderWorkspaceDO>;
	ARTIFACTS: DurableObjectNamespace<import("./src/index").Artifacts>;
	HANDLE_TASK_WORKFLOW: Workflow<Parameters<import("./src/index").HandleTaskWorkflow['run']>[0]['payload']>;
	ARC_HANDLE_TASK_WORKFLOW: Workflow<Parameters<import("./src/index").ArcHandleTaskWorkflow['run']>[0]['payload']>;
	NOTIFY_WORKFLOW: Workflow<Parameters<import("./src/index").NotifyTaskWorkflow['run']>[0]['payload']>;
	CF_CODER_WORKFLOW: Workflow<Parameters<import("./src/index").CfCoderWorkflow['run']>[0]['payload']>;
	CLAUDE_CODER_WORKFLOW: Workflow<Parameters<import("./src/index").ClaudeCoderWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ReactiveAgent" | "ProactiveAgent" | "ArcPlayerAgent" | "ClaudeCoderAgent" | "ClaudeCoderWorkspaceDO" | "Artifacts" | "CfCoderAgent" | "CfCoderWorkspaceDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "A2A_SIGNING_KEY" | "GATEKEEPER_ORIGINS" | "ARC_API_KEY" | "GITHUB_TOKEN" | "GITHUB_NAME" | "GITHUB_EMAIL" | "CLAUDE_CODE_OAUTH_TOKEN_1" | "CLAUDE_CODE_OAUTH_TOKEN_2" | "CLAUDE_CODE_OAUTH_TOKEN_3">> {}
}
